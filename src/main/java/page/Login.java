...
public class Login {
	...
	Textbox txtPassWord;
	Button btnLogin;
	Message msErrorLogin;
	Form fmLogin;
	
	public Login() {
		msErrorLogin = new Message(By.xpath("//p[@class='message error LoginForm']"));
		fmLogin = new Form (By.xpath("//form[@class='LoginForm']"));
		txtUserName = new Textbox(By.id("username"));
		txtPassWord = new Textbox(By.id("password"));
		btnLogin = new Button(By.xpath("//p[@class='form-actions']//input"));
	}
